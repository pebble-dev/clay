// Single source of truth for minified.js type declarations.
// Provides both global interfaces (via declare global) and module
// export (via export =) for tsify/browserify resolution.
